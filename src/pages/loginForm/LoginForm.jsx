...
const LoginForm = () => {
  ...
  const handleUserLogin = async (e) => {
    ...
    if (localStorage.getItem("guest_id")) {
      toast.info("Your Are Already Login");
      return;
    }
    const userData = await fetchApi("/authentication/guest_session/new");
    localStorage.setItem(
      "guest_id",
      JSON.stringify({ userName, email, password, ...userData })
    );
  ...
  return (
    <div className="w-full h-screen bg-[#1e1e1e] max-w-[1400px] mx-auto relative overflow-hidden flex items-center justify-center ">
      {/* <!-- component --> */}
      <div className="flex max-h-[400px] max-w-[700px] w-11/12 h-full">
        {/* <!-- Left Pane --> */}
              ...
              <div>
                <div className="flex items-center gap-3">
                  ...
                  <span
                    ...
                    className="focus:outline-none group focus:ring-gray-300 rounded-full focus:ring-offset-2 focus:ring-2 focus:bg-gray-200 relative"
                  >
                    ...
                    <div
                      id="tooltip1"
                      role="tooltip"
                      className="z-20 -mt-12 w-40 hidden group-hover:block absolute transition duration-150 ease-in-out left-0 ml-8 shadow-lg bg-white p-4 rounded"
                    >
                      <svg
                      ...
                      <p className="text-xs leading-4 text-gray-600 ">test</p>
                    </div>
                  </span>
                </div>
